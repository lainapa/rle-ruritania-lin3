...
- Access to the GCP project (e.g., `rle-ruritania-lin3`)
...
```bash
gcloud projects add-iam-policy-binding "rle-ruritania-lin3" \
  --member="serviceAccount:github-actions-rle@rle-ruritania-lin3.iam.gserviceaccount.com" \
...
```bash
gcloud projects describe rle-ruritania-lin3 --format="value(projectNumber)"
```
...
gcloud iam service-accounts add-iam-policy-binding \
  "github-actions-rle@rle-ruritania-lin3.iam.gserviceaccount.com" \
  --project="rle-ruritania-lin3" \
...
| `GCP_SERVICE_ACCOUNT` | `github-actions-rle@rle-ruritania-lin3.iam.gserviceaccount.com` |
...
```
Caller does not have required permission to use project rle-ruritania-lin3.
